...
class Trainer(DefaultTrainer):
    ...
    def build_hooks(self):
        ...
        ret.append(hooks.BestCheckpointer(eval_period = self.cfg.TEST.EVAL_PERIOD, checkpointer=self.checkpointer, val_metric="DET_RESULT/hmean", file_prefix = "model_best"))
