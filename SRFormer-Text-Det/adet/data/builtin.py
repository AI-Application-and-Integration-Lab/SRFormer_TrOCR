...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "d503_train": ("d503_SRFormer_format/train", "d503_SRFormer_format/train_poly_pos.json"),
    "d501_train": ("d501_SRFormer_format/train", "d501_SRFormer_format/train_poly_pos.json"),
    "d503_test": ("d503_SRFormer_format/test", "d503_SRFormer_format/test_poly_pos.json"),
    #-------------------------------------------------------------------------------------------------------
    ...
    "mlt_valid_test": ("valid_mlt/All", 'valid_mlt/mlt_valid_test.json'),
    "chinese_test": ("valid_mlt/Chinese", 'valid_mlt/Chinese_test.json'),
    "latin_test": ("valid_mlt/Latin", 'valid_mlt/Latin_test.json'),
    "japanese_test": ("valid_mlt/Japanese", 'valid_mlt/Japanese_test.json'),
    "korean_test": ("valid_mlt/Korean", 'valid_mlt/Korean_test.json'),
    "bangla_test": ("valid_mlt/Bangla", 'valid_mlt/Bangla_test.json'),
    "arabic_test": ("valid_mlt/Arabic", 'valid_mlt/Arabic_test.json'),
    "except_test": ("valid_mlt/except_latin", 'valid_mlt/ExceptLatin_test.json'),
}
